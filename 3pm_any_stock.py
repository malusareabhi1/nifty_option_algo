...
def display_current_trend(df):
    ...
    if close_price > open_price:
        st.markdown("<span style='color:green; font-weight:bold;'>Trend: Bullish 🔥</span>", unsafe_allow_html=True)
    elif close_price < open_price:
        st.markdown("<span style='color:red; font-weight:bold;'>Trend: Bearish ❄️</span>", unsafe_allow_html=True)
    else:
        st.markdown("<span style='color:gray; font-weight:bold;'>Trend: Doji ⚪</span>", unsafe_allow_html=True)
